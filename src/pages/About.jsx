  ...
  return (
    <div>
      <div className="container">
        ...
        <h2 className='text-btnColor text-xl font-semibold text-center !-mb-2 !mt-5'>Join the ClickCart Family</h2>
        ...
        <div className='text-center'>
         <Link to={'/product'} > <button className='bg-btnColor px-3 py-1 !mt-3 rounded-sm text-white '>start Shoping</button></Link>
        </div>
      </div>
      </div>
    </div>
