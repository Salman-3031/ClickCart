            ...
            <div className="container h-full py-5">
                {singleProduct ? (
                    <div className=' h-full'>
                        ...
                        <div className="product-details mt-5 grid grid-cols-1 sm:grid-cols-2 gap-10  ">
                            <div className="product-img h-96  overflow-hidden place-self-center">
                                <img className='h-full w-auto object-cover' src={singleProduct.image} alt="" />
                            </div>
                            ...
                            <div className="info space-y-3">
                                ...
                                <p className='space-x-1'><span className='text-btnColor'>${singleProduct.price} </span><span className='line-through'>${originalPrice}</span> <span className='text-white px-2 py-1 bg-btnColor rounded-sm'>{singleProduct.discount}% dicount</span></p>
